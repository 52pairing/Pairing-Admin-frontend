...
export default function AdminMembersPage() {
  ...
  return <div className="min-h-screen bg-[#f7f8fa] p-4 sm:p-6 xl:p-8">
    ...
    <section className="mt-6 overflow-hidden rounded-xl border border-[#e2e8f0] bg-white">
      <UserFilter value={filterInput} onChange={setFilterInput} disabled={isListLoading} onSearch={() => { setPage(0); setFilters(filterInput); }} onReset={() => { setFilterInput(EMPTY_FILTERS); setPage(0); setFilters(EMPTY_FILTERS); }} />
